...
namespace eShopSolution.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        //SỰ KHÁC BIỆT CHÍNH GIỮA CHÚNG LÀ TRONG CÁCH CHÚNG XỬ LÝ THỰC HIỆN LƯU DỮ LIỆU.SAVECHANGES() LÀ ĐỒNG BỘ,
        //    NGHĨA LÀ NÓ SẼ CHỜ ĐỢI CHO ĐẾN KHI THAO TÁC LƯU DỮ LIỆU HOÀN TẤT TRƯỚC KHI TRẢ VỀ.
        //    TRONG KHI ĐÓ, SAVECHANGESASYNC() LÀ BẤT ĐỒNG BỘ, NGHĨA LÀ NÓ SẼ TIẾP TỤC THỰC HIỆN CÁC CÔNG VIỆC KHÁC TRONG KHI THỰC HIỆN 
        //    LƯU DỮ LIỆU VÀ KHÔNG CHỜ ĐỢI CHO ĐẾN KHI HOÀN TẤT.
        ...
        public async Task<int> AddReview(ProductDetailViewModel model)
        {
            ...
            // alt keo dai thanh hoi        
           //Khi gọi SaveChangesAsync(), các thay đổi trong đối tượng DbContext sẽ được gửi đến cơ sở dữ liệu và lưu trữ lại.Việc sử dụng
            //    await đảm bảo rằng chương trình sẽ chờ đợi cho đến khi tất cả các thay đổi đã được lưu vào cơ sở dữ liệu trước khi tiếp 
            //    tục thực hiện các dòng code tiếp theo.
            await _context.SaveChangesAsync();
