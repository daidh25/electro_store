...
namespace eShopSolution.ViewModels.Catalog.Products // Khai báo namespace cho lớp ProductCreateRequest.
{
    // create thì không cần id, vì khi create sql sẽ tự động generate id tăng dần
    public class ProductCreateRequest // Định nghĩa lớp ProductCreateRequest để đại diện cho yêu cầu tạo mới sản phẩm.
    {
