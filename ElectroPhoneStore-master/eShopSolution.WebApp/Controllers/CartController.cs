...
using eShopSolution.WebApp.Models.Vnpay;
...
namespace eShopSolution.WebApp.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(IProductApiClient productApiClient, IVnPayService vnPayservice, IOrderApiClient orderApiClient, IUserApiClient userApiClient, ICouponApiClient couponApiClient)
        {
        ...
        public async Task<IActionResult> Checkout(CheckoutViewModel request)
        {
            ...
            if (result != "Failed")
            {
                ...
                email1.Send("cuongdoladola2002@gmail.com", "cuongdoladola2002@gmail.com",
                ...
                email2.Send("cuongdoladola2002@gmail.com", userMail,
                                "ĐẶT HÀNG THÀNH CÔNG",
                                templateHtml
                                + orderSummaryHtml
                                );
        ...
        public async Task<IActionResult> Checkout1(CheckoutViewModel request, string payment = "Vnpay")
        {
            if (!ModelState.IsValid)
            {
                return View(request);
            ...
            else
            {
                ...
                if (payment == "Thanh toán VNPay")
                {
                    ...
                    HttpContext.Session.SetString("Address", request.CheckoutModel.Address);
                    HttpContext.Session.SetString("Name", request.CheckoutModel.Name);
                    HttpContext.Session.SetString("PhoneNumber", request.CheckoutModel.PhoneNumber.ToString());
                    var vnPayModel = new VnPaymentRequestModel
                    {
                        //checkoutViewModel = request,
                        Adress = request.CheckoutModel.Address,
                        PhoneNumber = Convert.ToInt64(request.CheckoutModel.PhoneNumber),
        ...
        //public async Task<IActionResult> PaymentSuccess(CheckoutViewModel request)
